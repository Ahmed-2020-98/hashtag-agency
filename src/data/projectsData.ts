...
export const projects: Project[] = [
    ...
    {
        slug: "inbat-holding",
        title: "INBAT HOLDING - إنبات القابضة",
        category: "تصميم مواقع",
        desc: "منصة رقمية احترافية للمجموعة القابضة الزراعية الرائدة في السعودية.",
        fullDescription:
            "تم تطوير موقع INBAT HOLDING - إنبات القابضة في فبراير 2026 باستخدام تقنية Next.js، ليكون منصة رقمية احترافية تعكس هوية المجموعة كواحدة من الشركات الرائدة في القطاع الزراعي داخل المملكة العربية السعودية.",
        thumbnail: "/assets/portfolio/websites/project24/3.webp",
        images: [
            "/assets/portfolio/websites/project24/3.webp",
            "/assets/portfolio/websites/project24/4.webp",
            "/assets/portfolio/websites/project24/5.webp",
        ],
        year: "فبراير 2026",
    },
];
